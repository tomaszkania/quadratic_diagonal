...
\date{\today}
\keywords{algorithms, quadratic forms, real quadratic fields, rings of integers, diagonal representability, dynamic programming}
...
\begin{abstract}
We present \texttt{quadratic\_diagonal}, a self-contained pure-Python reference implementation and
accompanying exact algorithms for constructive representability by diagonal quadratic lattices over
maximal real quadratic orders. The package exposes exact weighted-value enumeration,
dynamic-programming and meet-in-the-middle solvers for single targets, and a batched bounded routine
for representable targets and bounded truants. Its core primitive is weighted trace-form
enumeration via $q_a(x)=\Tr(a x^2)$. We prove
\[
4A_aC_a-B_a^2=4\Disc(K_D)\N(a),
\]
deduce the distinct-value asymptotic, and use a canonical half-ellipse scan with exact order
comparison. For fixed field and fixed lattice the resulting algorithms have pseudo-polynomial
$O(\Tr(\alpha)^3)$ complexity for single targets and $O(B^3)$ for bounded search. The public
repository includes the installable package, tests, benchmark scripts, a reproducible generic exact
baseline for comparison, performance plots, and an executed notebook reproducing the computational
section.
\end{abstract}
...
\]
and, if so, to construct such a representation. The package API is centred around the exact order
model \texttt{RealQuadraticOrder}, the weighted-search routine \path{enumerate_weighted_search},
the constructive solvers \path{diagonal_representability_dp} and
\path{diagonal_representability_mitm}, and the batched bounded routines
\path{batched_bounded_representables} and \path{bounded_truants_batched}.
...
in the same spirit as the author's companion public repository
\url{https://github.com/tomaszkania/quadratic_sos}, which treats the unweighted
$\langle 1,\dots,1\rangle$ case. For broader arithmetic background on universal forms and
...
repeated-coefficient caching gains, and split preprocessing/combination/end-to-end timings.
\end{enumerate}
...
\url{https://github.com/tomaszkania/quadratic_sos} for the unweighted case.
...
\item The weighted-search implementation scans only a canonical half-ellipse, so the candidate-count
      columns below report canonical candidates rather than all non-zero roots. The omitted full root
      counts are recovered by doubling and adding the central point.
...
\midrule
21 & $(2,1)$ & $(30,0)$ & 13 & 19 & 73  & 6589 & 0.029 & 0.037 & 1.334 \\
21 & $(2,1)$ & $(40,0)$ & 17 & 29 & 112 & 8950 & 0.041 & 0.058 & 1.851 \\
6  & $(3,-1)$ & $(30,0)$ & 6  & 11 & 27  & 6937 & 0.015 & 0.017 & 1.374 \\
5  & $(1,1)$ & $(30,0)$ & 27 & 41 & 123 & 2146 & 0.058 & 0.072 & 0.422 \\
10 & $(1,0)$ & $(40,0)$ & 14 & 18 & 32  & 4105 & 0.027 & 0.030 & 0.728 \\
\bottomrule
\end{tabular}
...
\midrule
10 & $[(1,0),(4,1)]$ & $(18,2)$ & $[1,0]$ & $[1,5]$ & $[2,11]$ & 2 & 6 & 0.036 & 0.010 & 0.048 & 0.008 & 0.045 \\
5  & \shortstack[l]{$[(1,0),(1,0),$\\$(1,0)]$} & $(15,1)$ & $[0,1,2]$ & \shortstack[l]{$[13,13,$\\$13]$} & \shortstack[l]{$[14,61,$\\$108]$} & 14 & 61 & 0.041 & 0.650 & 0.704 & 0.149 & 0.197 \\
21 & \shortstack[l]{$[(2,1),(1,0),$\\$(1,0),(1,0)]$} & $(30,0)$ & \shortstack[l]{$[1,2,$\\$3,0]$} & \shortstack[l]{$[12,12,$\\$12,13]$} & \shortstack[l]{$[13,60,$\\$131,195]$} & 60 & 95 & 0.079 & 1.723 & 1.806 & 0.260 & 0.343 \\
13 & \shortstack[l]{$[(1,0),(2,1),$\\$(2,1),(1,0)]$} & $(18,0)$ & \shortstack[l]{$[1,2,$\\$0,3]$} & \shortstack[l]{$[5,5,$\\$9,9]$} & \shortstack[l]{$[6,15,$\\$49,84]$} & 15 & 35 & 0.070 & 0.475 & 0.481 & 0.111 & 0.165 \\
\bottomrule
\end{tabularx}
...
\midrule
10 & $(18,2)$ & $[1,0]$ & 12 & 0.027 & 0.034 & 0.033 & 0.029 \\
5  & $(15,1)$ & $[0,1,2]$ & 2744 & 0.036 & 0.512 & 0.140 & 0.846 \\
21 & $(30,0)$ & $[1,2,3,0]$ & 30758 & 0.078 & 1.346 & 0.265 & 12.490 \\
13 & $(18,0)$ & $[1,2,0,3]$ & 3600 & 0.049 & 0.406 & 0.135 & 1.422 \\
\bottomrule
\end{tabular}
...
Table~\ref{tab:generic} is the TOMS-facing comparison point. The artifact does not depend on an
...
\midrule
10 & $[(1,0),(4,1)]$ & $(18,2)$ & $[1,0]$ & $[6,11]$ & $[2,11]$ & 0.035 & 0.034 & 0.051 & 0.047 \\
13 & \shortstack[l]{$[(1,0),(2,1),$\\$(2,1),(1,0)]$} & $(18,0)$ & \shortstack[l]{$[1,2,$\\$0,3]$} & \shortstack[l]{$[10,31,$\\$49,84]$} & \shortstack[l]{$[6,15,$\\$49,84]$} & 0.107 & 0.057 & 0.603 & 0.523 \\
21 & \shortstack[l]{$[(2,1),(1,0),$\\$(1,0),(1,0)]$} & $(30,0)$ & \shortstack[l]{$[1,2,$\\$3,0]$} & \shortstack[l]{$[14,95,$\\$190,195]$} & \shortstack[l]{$[13,60,$\\$131,195]$} & 0.172 & 0.079 & 2.654 & 1.873 \\
\bottomrule
\end{tabularx}
...
\midrule
5  & $[(1,0),(1,0),(1,0)]$ & 10 & 25 & 0  & $[7,7,7]$ & $[8,20,26]$ & $0.019/0.115/0.192/1.234$ \\
10 & $[(1,0),(4,1)]$       & 18 & 6  & 21 & $[1,3]$   & $[2,7]$     & $0.020/0.006/0.069/1.058$ \\
21 & $[(2,1),(1,0),(1,0)]$ & 16 & 23 & 7  & $[4,6,6]$ & $[5,18,24]$ & $0.028/0.079/0.172/1.748$ \\
\bottomrule
\end{tabular}
...
\emph{Geometry of Numbers}, 2nd ed., North-Holland, Amsterdam, 1987.

\bibitem{KalaSurvey}
V.~Kala,
\emph{Universal quadratic forms and indecomposables in number fields},
Commun. Math. \textbf{31} (2023), no.~2, 81--114.

\bibitem{KKK}
V.~Kala, K.~Kramer, and J.~Kr\'asensk\'y,
\emph{Kitaoka's conjecture and sums of squares},
arXiv:2510.19545.

\bibitem{KKR}
V.~Kala, J.~Kr\'asensk\'y, and G.~Romeo,
\emph{Universality criterion sets for quadratic forms over number fields},
arXiv:2410.22507.

\bibitem{KopCz}
P.~Koprowski and A.~Czoga{\l}a,
\emph{Computing with quadratic forms over number fields},
J. Symbolic Comput. \textbf{89} (2018), 129--145.

\bibitem{KopIso}
P.~Koprowski,
\emph{Isotropic vectors over global fields},
Math. Comp. \textbf{95} (2026), 1541--1567.

\bibitem{KopRoth}
P.~Koprowski and B.~Rothkegel,
\emph{The anisotropic part of a quadratic form over a number field},
J. Symbolic Comput. \textbf{115} (2023), 39--52.

\bibitem{KopSq}
P.~Koprowski,
\emph{Solving sums of squares in global fields},
Proc. ISSAC 2022, 319--324; see also arXiv:2111.08558.

\bibitem{Raska}
M.~Ra\v ska,
\emph{Representing multiples of $m$ in real quadratic fields as sums of squares},
J. Number Theory \textbf{244} (2023), 24--41.
